...
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseExpr","Expr","Disj","Conj","Negate","VARIABLE","IMPL","OR","AND","NOT","LEFTBRACKET","RIGHTBRACKET","%eof"]
        bit_start = st * 15
        bit_end = (st + 1) * 15
...
happyReduction_8 (HappyTerminal (Variable happy_var_1))
	 =  HappyAbsSyn7
		 (Var happy_var_1
	)
